...
describe("Client", () => {
    it("should create a valid client", () => {
        const client = new Client("1", "Luis", "luis01", "123456789", "Santo Domingo", "8091234567", "plan-basic");
    ...
    it("should throw if activating twice", () => {
        const client = new Client("1", "Luis", "luis01", "123456789", "Santo Domingo", "8090000000", "plan-basic");
        client.activate();
