...
describe("List clients usecase", () => {
    ...
    it("should return list of clients", async () => {
        ...
        const client2 = new Client(randomUUID(), "Luis", "luis01", "123456789", "Santo Domingo", "8090000000", "plan-basic", "PENDING_INSTALLATION", "router-123");
...
//# sourceMappingURL=ListClientsUseCase.test.js.map