...
describe("SuspendClientUseCase", () => {
    it("should suspend an ACTIVE client successfully", async () => {
        ...
        const client = new Client(randomUUID(), //“Para darle un nombre único a cada cliente”
        "Luis", "luis01", "123456789", "Santo Domingo", "8090000000", "plan-basic", "PENDING_INSTALLATION", "router-123");
    ...
    it("should throw if client is not ACTIVE", async () => {
        const repository = new InMemoryClientRepository();
        const client = new Client(randomUUID(), "Luis", "luis01", "123456789", "Santo Domingo", "8090000000", "plan-basic", "PENDING_INSTALLATION", "router-123");
        //guardar
        await repository.save(client);
        const usecase = new SuspendClientUseCase(repository);
...
//# sourceMappingURL=SuspendClientUseCase.test.js.map