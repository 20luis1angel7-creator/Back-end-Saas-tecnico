...
export const generateMonthlyInvoicesUseCase = new GenerateMonthlyInvoicesUseCase(planRepository, clientRepository, invoiceRepository, idGenerator);
export const getClientInvoiceUseCase = new GetClientInvoiceUseCase(invoiceRepository);
export const recalculateClienStatusUseCase = new RecalculateClienStatusUseCase(clientRepository, invoiceRepository);
export const registerInvoicePaymentUseCase = new RegisterInvoicePaymentUseCase(invoiceRepository, recalculateClienStatusUseCase);
...
export const registerPaymentUseCase = new RegisterPaymentUseCase(invoiceRepository, paymentRepository, idGenerator);
